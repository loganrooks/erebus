...
- Finding 16: resolved per 0002 §Finding-16; added new REQ-SEC-006
  (MUST, phase:1) requiring synthetic-only fixtures generated by
  scripts/generate_fixtures.py and gitignoring lab/clips/ pending
  per-clip provenance ADRs; extended REPO_SETUP.md §3.1 .gitignore
